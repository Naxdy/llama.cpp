...
enum llm_tensor {
    ...
    LLM_TENSOR_INDEXER_K_NORM,      //DSA, MSA
    LLM_TENSOR_INDEXER_PROJ,        //DSA
    LLM_TENSOR_INDEXER_ATTN_K,      //DSA
    LLM_TENSOR_INDEXER_ATTN_Q_B,    //DSA
    ...
    LLM_TENSOR_INDEXER_Q_PROJ,      //MSA
    LLM_TENSOR_INDEXER_K_PROJ,      //MSA
    LLM_TENSOR_INDEXER_Q_NORM,      //MSA
